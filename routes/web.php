...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'permissions:general_settings'], function () {
        ...
        // --- Photocard Frame Actions ---
        Route::get('/photocard/frames', 'Admin\PhotocardFrameController@index')->name('admin.photocard.index');
        Route::post('/photocard/frames/store', 'Admin\PhotocardFrameController@store')->name('admin.photocard.store');
        Route::get('/photocard/frames/delete/{id}', 'Admin\PhotocardFrameController@delete')->name('admin.photocard.delete');
        //------------General Settings-----------
    });
...
Route::post('the/elitedesign/ocean/2441139', 'Front\FrontendController@subscription');
