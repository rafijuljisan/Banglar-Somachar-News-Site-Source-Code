    ...
    <div class="col-md-12 custom-padding">
      <div class="marquee-block">
		...
		@foreach($is_trendings as $is_trending)	
          <li><a href="{{ route('frontend.details',[$is_trending->id,$is_trending->slug])}}"><span><img class="img-fluid" src="{{asset('assets/images/'.$gs->favicon)}}"></span>   {{$is_trending->title}}</a></li>      
		  @endforeach
		  @else
			  <li><a href="#"><span><img class="img-fluid" src="{{asset('assets/images/'.$gs->favicon)}}"></span>এই মুহূর্তে কোন ব্রেকিং নিউজ নেই, দয়া করে নিউজ পোস্ট করুন।</a></li>      
		  @endif
		  </div><!--/.marquee-block-->
    </div><!--/.col-md-12-->
    </div><!--/.row-->
...
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="-1183.849 0 1065.106 1391" enable-background="new -1183.849 0 1065.106 1391" xml:space="preserve">
<g id="Dhaka">
...
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="-535.125,393.801 -532.905,390.422
-532.228,388.201 -532.905,390.421 -535.125,393.8 -536.962,397.662 -539.276,405.965 -539.276,405.965 -536.962,397.663 "></polygon>
...
<rect x="-501.047" y="578.667" fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" width="0" height="2.635"></rect>
...
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="-745.205,902.394 -745.108,903.746
...
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="-752.255,926.144 -747.039,926.723
...
<path fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" d="M-472.76,501.544l-2.896,7.626L-472.76,501.544z"></path>
...
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="-461.175,583.413 -455.476,579.938
...
<path fill="#231F20" d="M-649.436,648.055v3.958c6.308,0,11.393,2.575,15.255,7.725c3.668,4.634,5.502,9.719,5.502,15.254
...
c-3.282,1.835-6.758,4.04-10.427,6.612c9.01,3.8,15.704,9.816,20.082,18.055h0.191L-654.844,660.026L-654.844,660.026z"></path>
...
<g class="khulna-dev">
<path fill="#231F20" d="M-880.583,894.838h-5.459v36.522c-0.461-0.417-0.879-0.909-1.255-1.476
...
c0,0.712,0.041,1.423,0.125,2.134c0.083,0.712,0.167,1.192,0.251,1.443c0.46,1.004,1.443,1.568,2.949,1.694L-880.583,894.838z"></path>
...
<rect x="-801.926" y="789.195" fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" width="0" height="6.275"></rect>
...
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="-623.076,842.15 -626.455,843.502
-634.469,843.502 -633.406,846.785 -631.671,856.053 -629.931,854.991 -625.2,849.198 -622.014,846.012 -621.725,844.371 "></polygon>
<g id="Barishal">
...
"></polygon>
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="-650.109,1078.296 -648.76,1072.698
-651.557,1073.276 -654.744,1078.393 -657.447,1084.958 -658.701,1089.785 -657.447,1089.785 -655.998,1085.055 	"></polygon>
...
<path fill="#231F20" d="M-664.593,967.242v36.898l-1.944-2.321v0.063c-0.67-1.673-1.225-2.896-1.663-3.672
...
c-2.259,0.837-4.55,1.841-6.872,3.012c-2.322,1.172-4.76,2.615-7.311,4.33c6.316,2.636,11.045,6.651,14.183,12.049V975.526z"></path>
...
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="-339.527,1122.9 -336.633,1117.204
-335.955,1113.631 -336.245,1110.446 -338.757,1102.046 -339.047,1100.213 -340.203,1098.86 -345.129,1104.459 -346.673,1107.355
-347.443,1111.218 -345.899,1122.706 -349.181,1141.34 -347.443,1145.105 -345.706,1142.98 -341.17,1130.721 	"></polygon>
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="-487.915,970.071 -495.255,973.258
...
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="-507.224,580.516 -514.177,590.074
-518.906,591.715 -514.177,590.074 -507.223,580.517 -504.427,582.737 -503.302,583.158 -504.427,582.736 "></polygon>
...
-575.191,719.152 -572.68,717.898 -569.494,717.513 -569.011,716.354 -570.091,714.823 -569.012,716.354 "></polygon>
...
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="-491.777,573.661 -495.349,574.916
...
<path fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" d="M-210.061,421.315l-1.642-3.668l-1.933-1.933
...
l0.193,1.737l0.867,1.159l1.546,0.676l2.025,0.29l12.744-4.248l7.435-2.028l2.896-4.538l0.676-2.51L-210.061,421.315z"></path>
</a>
<g class="sylhet-dev">
...
<path fill="#231F20" d="M-404.752,483.517v37.025c-0.587-0.669-1.16-1.328-1.726-1.978c-0.563-0.647-1.12-1.308-1.663-1.978
...
s1.914-0.429,2.793-0.094s1.758,0.963,2.636,1.882c0.88,0.921,1.819,2.029,2.824,3.326V483.517L-408.139,483.517z"></path>
<path fill="#231F20" d="M-376.889,483.517c-2.636,0.628-4.916,1.611-6.84,2.95c-1.925,1.339-3.557,3.012-4.896,5.021
...
c-1.842-3.346-2.762-7.217-2.762-11.608c0-6.107,2.488-12.069,7.469-17.886h-11.673l-3.515-3.514h23.281L-376.889,483.517z"></path>
...
-480.288,521.625 -478.744,522.59 -476.427,522.784 -473.919,523.942 -472.76,529.348 -473.916,523.941 "></polygon>
...
<polygon fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" points="-488.977,470.649 -490.135,470.166
...
<path fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" d="M-778.416,501.833l1.062-2.51L-778.416,501.833z"></path>
...
-983.378,599.342 -988.399,596.639 -989.75,595.48 -993.032,590.459 -993.998,586.985 -993.998,586.985 "></polygon>
...
-921.783,633.519 -913.77,640.47 -909.329,643.366 -904.791,645.49 -899.095,646.552 -904.791,645.489 "></polygon>
...
<path fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" d="M-924.39,629.078l0.58,2.027L-924.39,629.078z"></path>
...
<path fill="#231F20" d="M-607.972,436.688v37.024c-0.586-0.669-1.16-1.328-1.726-1.978c-0.564-0.647-1.12-1.308-1.663-1.978
...
c0.981-0.397,1.914-0.429,2.793-0.094s1.757,0.963,2.635,1.882c0.879,0.921,1.82,2.03,2.824,3.326V436.688L-611.361,436.688z"></path>
...
<path fill="#231F20" d="M-546.286,436.688h-18.575c0.334,0.461,0.668,0.909,1.004,1.35c0.334,0.438,0.648,0.847,0.941,1.224
...
c1.631-1.507,3.535-2.343,5.711-2.511c0-0.669-0.795-1.609-2.385-2.823h-12.552l-3.515-3.515h35.519L-546.286,436.688z"></path>
</g>
</g>
...
<rect x="-529.316" y="422.08" fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" width="0.001" height="0.974"></rect>
...
-771.177,617.589 -769.244,614.403 -767.7,611.313 -767.12,603.204 -765.094,599.343 -765.674,598.956 "></polygon>
</a>
<g class="rajshahi-dev">
<path fill="#231F20" d="M-975.627,511.033v36.898l-1.945-2.321v0.063c-0.67-1.673-1.224-2.896-1.663-3.672
...
c-2.259,0.837-4.55,1.841-6.872,3.012c-2.321,1.172-4.76,2.615-7.311,4.33c6.317,2.636,11.045,6.651,14.183,12.049V519.317z"></path>
...
<path fill="#231F20" d="M-829.539,511.033h-18.575c0.334,0.461,0.668,0.91,1.004,1.35c0.334,0.439,0.647,0.848,0.94,1.225
...
c1.631-1.506,3.535-2.342,5.71-2.51c0-0.67-0.796-1.61-2.385-2.824h-12.551l-3.515-3.515h35.519L-829.539,511.033z"></path>
...
-771.368,308.262 -774.844,308.938 -777.839,310.869 -779.673,314.248 -784.402,325.64 -779.673,314.248 "></polygon>
<path fill="#0E660C" stroke="#9B9B9B" stroke-width="2" stroke-miterlimit="10" d="M-795.891,364.451l-2.724-0.279L-795.891,364.451
z"></path>
</a>
<g class="rangpur-dev">
<path fill="#231F20" d="M-930.704,245.987v36.899l-1.945-2.322v0.063c-0.67-1.673-1.224-2.896-1.663-3.672
...
c-2.26,0.837-4.551,1.841-6.872,3.012c-2.322,1.172-4.761,2.615-7.312,4.33c6.317,2.636,11.045,6.651,14.184,12.049V254.271z"></path>
...
<path fill="#231F20" d="M-861.74,294.057c-0.627-0.837-1.318-1.685-2.071-2.541c-0.753-0.858-1.538-1.674-2.354-2.447
...
c0.963-0.627,1.61-1.276,1.944-1.945c-0.417-0.461-0.888-0.805-1.412-1.035C-876.413,282.124-877.009,281.945-877.679,281.82z"></path>
<path fill="#231F20" d="M-837.893,245.987v36.899l-1.945-2.322v0.063c-0.67-1.673-1.224-2.896-1.663-3.672
...
c-2.259,0.837-4.55,1.841-6.872,3.012c-2.322,1.172-4.76,2.615-7.311,4.33c6.316,2.636,11.044,6.651,14.183,12.049V254.271z"></path>
</g>
</g>
...
#Khulna:hover .khulna-dev path{fill: #fff; cursor: pointer; transition: all 0.5s ease 0s;}

#Barishal:hover polygon{fill: #0c4d0b; cursor: pointer; transition: all 0.5s ease 0s;}
#Barishal:hover .barishal-dev path{fill: #fff; cursor: pointer; transition: all 0.5s ease 0s;}

#Chittagong:hover polygon{fill: #0c4d0b; cursor: pointer; transition: all 0.5s ease 0s;}
#Chittagong:hover .chittagong-dev path{fill: #fff; cursor: pointer; transition: all 0.5s ease 0s;}

#Rajshahi:hover polygon{fill: #0c4d0b; cursor: pointer; transition: all 0.5s ease 0s;}
#Rajshahi:hover .rajshahi-dev path{fill: #fff; cursor: pointer; transition: all 0.5s ease 0s;}
...
#Rangpur:hover .rangpur-dev path{fill: #fff; cursor: pointer; transition: all 0.5s ease 0s;}

#Dhaka:hover path{fill: #0c4d0b; cursor: pointer; transition: all 0.5s ease 0s;}
#Dhaka:hover .dhaka-dev path{fill: #fff; cursor: pointer; transition: all 0.5s ease 0s;}
</style>
</svg>
