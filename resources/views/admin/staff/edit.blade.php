        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="product-description">
                    ...
                    <form id="elitedesignformdata" action="{{ route('admin.staff.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <input type="text" class="input-field" name="designation" placeholder="{{ __("Staff Designation") }}" required="" value="{{ $data->designation}}">
                            </div>
                        </div>
