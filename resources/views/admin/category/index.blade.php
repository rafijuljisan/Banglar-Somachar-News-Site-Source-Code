        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li>
                        <a href="{{ route('categories.index') }}">{{ __('Main Categories') }}</a>
                    </li>
                </ul>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(function () {
        $(".btn-area").append('<div class="col-sm-4 table-contents">' +'<a class="add-btn" data-href="{{route('categories.categoriesCreate')}}" id="add-data" data-toggle="modal" data-target="#modal1">' 
