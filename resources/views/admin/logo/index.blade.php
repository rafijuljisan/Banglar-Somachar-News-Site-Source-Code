...
@section('content')
<input type="hidden" id="headerdata" value="{{ __('LANGUAGE LOGO') }}">

<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">{{ __('Language Base Logo') }}</h4>
                <ul class="links">
                    <li>
...
<div class="modal fade-scale" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-center">
                    {{ __('You are about to delete this Row') }}.
                </p>
...
<script type="text/javascript">
    ...
    var table = $('#elitedesigntable').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{{ route('admin.languagelogo.datatables') }}',
        columns: [
            {data: 'language_id',name: 'language_id'},
            {data: 'header_logo',name: 'header_logo'},
            {data: 'footer_logo',name: 'footer_logo'},
    ...
    $(function () {
        $(".btn-area").append('<div class="col-sm-4 table-contents">' +'<a class="add-btn" href="{{route('admin.languagelogo.create')}}">' 
        +'<i class="fas fa-plus"></i>{{__('Set Logos')}}' +'</a>' +'</div>');
    });
