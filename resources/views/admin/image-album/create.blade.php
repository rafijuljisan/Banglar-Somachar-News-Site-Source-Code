            ...
            <div class="col-lg-12">
                <div class="product-description">
                    ...
                    <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
                     <form id="elitedesignformdataedit"  action="{{ route('image.album.store')}}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                   <input type="text" name="album_name" placeholder="{{ __('Album Name') }}" class="input-field">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <button class="addProductSubmit-btn"
                                        type="submit">{{ __('Create Album') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
