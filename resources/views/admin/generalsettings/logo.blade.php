			   ...
			   <div class="col-xl-4 col-md-6">
                  <div class="special-box  bg-gray">
                      ...
                      <form class="uplogo-form" id="elitedesignform" action="{{ route('admin.generalsettings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="currrent-logo">
                          <img src="{{$data->logo ? asset('assets/images/logo/'.$data->lazy_baner):asset('assets/images/noimage.png')}}" alt="">
                        </div>
                        <div class="set-logo">
                          <input class="img-upload1" type="file" name="lazy_baner">
                        </div>
                  ...
                  <div class="special-box  bg-gray">
                      ...
                      <form class="uplogo-form" id="elitedesignform" action="{{ route('admin.generalsettings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="currrent-logo">
                          <img src="{{$data->logo ? asset('assets/images/logo/'.$data->og_images):asset('assets/images/noimage.png')}}" alt="">
                        </div>
                        <div class="set-logo">
                          <input class="img-upload1" type="file" name="og_images">
                        </div>
