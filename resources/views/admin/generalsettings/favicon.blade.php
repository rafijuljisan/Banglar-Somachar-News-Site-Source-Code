              ...
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('admin.generalsettings.favicon') }}">{{ __('Website Favicon') }}</a>
                      </li>
                    </ul>
                </div>
              </div>
                ...
                <div class="col-lg-6">
                  <form class="uplogo-form" id="elitedesignform"  action="{{ route('admin.generalsettings.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="currrent-logo">
                      ...
                      <img src="{{ $data->favicon ? asset('assets/images/'.$data->favicon):asset('assets/images/noimage.png')}}" alt="">
                    </div>
                    <div class="set-logo">
                      <h4 class="title">
                        {{ __('Set New Favicon') }} :
