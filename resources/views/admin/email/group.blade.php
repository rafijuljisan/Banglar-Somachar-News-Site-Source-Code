...
@section('content')
            ...
            <div class="mr-breadcrumb">
              <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Group Email To Subscribers') }}</h4>
                    <ul class="links">
                      <li>
                ...
                <div class="row  justify-content-center">
                  <div class="col-lg-8">
                    <div class="product-description">
                      ...
                      <form id="elitedesignform" action="{{route('admin.subscriber.sendemail')}}" method="POST" enctype="multipart/form-data">
