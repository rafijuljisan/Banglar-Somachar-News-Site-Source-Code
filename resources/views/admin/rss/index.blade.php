...
@section('content')
<input type="hidden" id="headerdata" value="{{ __('Rss News') }}">

<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">{{ __('Rss News') }}</h4>
                <ul class="links">
                    <li>
                        <a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }} </a>
                    </li>
                    <li>
                        <a href="{{ route('categories.index') }}">{{ __('Rss News') }}</a>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="modal fade-scale" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-center">
                    {{ __('You are about to delete this Rss News') }}.
                </p>
...
<script type="text/javascript">
    var table = $('#elitedesigntable').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{{ route('rss.datatables') }}',
        columns: [
            {data: 'language_id',name: 'language_id'},
            {data: 'category_id',name: 'category_id'},
            {data: 'feed_name',name: 'feed_name'},
