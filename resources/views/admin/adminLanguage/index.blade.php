        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li>
                        <a href="{{ route('admin.admin_language.index') }}">{{ __('Admin Language') }}</a>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="modal fade-scale" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-center">
                    {{ __('You are about to delete this Language.Everything under this language will be deleted') }}.
                </p>
...
<script type="text/javascript">
    var table = $('#elitedesigntable').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{{ route('admin_language.datatables') }}',
        columns: [
    ...
    $(function() {
		$(".btn-area").append('<div class="col-sm-4 table-contents">'+
			'<a class="add-btn" href="{{route('admin.admin_language.create')}}" id="add-data">'+
