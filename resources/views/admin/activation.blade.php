							...
							@if($activation_data != "")
								<div class="row">
									...
									<div class="col-lg-12 text-center" style="color:darkgreen">
										...
										বিস্তারিত জানতে ভিজিটঃ www.futureitlimited.com | ইমেইলঃ futureitlimited@gmail.com

									</div>
								</div>
							@else
								<form id="elitedesignform" action="{{ route('admin-activate-purchase') }}" method="POST">
									{{csrf_field()}}
									...
									<div class="row">
										<div class="col-lg-4">
											<div class="left-area">
												...
												<p class="sub-heading"><a href="https://www.futureitlimited.com/howtogetpurchasecode" target="_blank">{{ __('How to get purchase code?') }}</a></p>
											</div>
										</div>
										<div class="col-lg-7">
