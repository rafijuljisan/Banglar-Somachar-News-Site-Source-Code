								...
								<div class="row">
									<div class="col-lg-12">
				                        ...
				                        <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
											<form id="elitedesignform" action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
												{{csrf_field()}}
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="designation" placeholder="{{ __('Your DESIGNATION') }}" required="" value="{{$data->designation}}">
													</div>
												</div>
