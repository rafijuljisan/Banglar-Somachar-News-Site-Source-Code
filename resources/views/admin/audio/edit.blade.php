...
<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">{{ __('Edit Audio') }}</h4>
                <ul class="links">
                    <li>
                                ...
                                <div class="product-description">
                                    <div class="body-area">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                            <input type="file" name="audio" id="audio1" value="{{$data->audio}}">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
...
<script src="{{asset('assets/admin/js/audioEdit.js')}}"></script>
